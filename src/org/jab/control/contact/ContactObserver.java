...
public class ContactObserver extends ContentObserver {
	...
	private DbPhoneBookRepository contactsRepository;
	...
	public void onChange(boolean selfChange) {
		...
		contactsRepository = new DbPhoneBookRepository(context);
						...
						Cursor phoneCursor = context.getContentResolver().query(ContactsContract.CommonDataKinds.Phone.CONTENT_URI, null, 
			     		...
			     		while(phoneCursor.moveToNext()){       				
			     			...
			     			if(number.length() >= 7){
			     				...
			     				HandyContact user = new HandyContact(contactId ,HelperFunctions.getInstance().cleanNumber(number), name ,null,version);
			     				handyContacts.add(user);
			     			}
